...
#Region "Methods"
    Private Sub DisplayList()
        ...
        End If
        With dgvmain
            .DataSource = clsPayment.Fetch(7, Me.txtSearch.Text)
            .Columns(0).HeaderText = "Reservation #"
            .Columns(0).Width = 108
            ...
            .Columns(6).HeaderText = "Expiration"
            .Columns(6).Width = 100
...
#End Region
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        Try
            If Me.dgvmain.CurrentRow.Index >= 0 Then
                Dim f As New frmEditInvoice
                f.myCurrentFormStatus = frmEditInvoice.enFormStatus.edit
                f.mInvoiceno = Me.dgvmain.CurrentRow.Cells("INVOICENO").Value
                f.ShowDialog()
                If f.issave Then
                    Call DisplayList()
                End If
    ...
    Private Sub btnView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnView.Click
        Try
            If Me.dgvmain.CurrentRow.Index >= 0 Then
                Dim f As New frmEditInvoice
                f.myCurrentFormStatus = frmEditInvoice.enFormStatus.view
                f.mInvoiceno = Me.dgvmain.CurrentRow.Cells("INVOICENO").Value
                f.ShowDialog()
                If f.issave Then
                    Call DisplayList()
    ...
    Private Sub btnOptions_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOptions.Click
        Try
            If dgvmain.CurrentRow.Index >= 0 Then
                ...
                f.mmoduleid = applicationmodule.modReservation
