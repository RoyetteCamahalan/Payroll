...
Public Class cr_showDownlines
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IRES.cr_showDownlines.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_showDownlines
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_showDownlines = New cr_showDownlines()
        rpt.Site = Me.Site
        Return rpt
    End Function
