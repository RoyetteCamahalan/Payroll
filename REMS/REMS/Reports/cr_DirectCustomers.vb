...
Public Class cr_DirectCustomers
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IRES.cr_DirectCustomers.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_agentid() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedcr_DirectCustomers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_DirectCustomers = New cr_DirectCustomers()
        rpt.Site = Me.Site
        Return rpt
    End Function
