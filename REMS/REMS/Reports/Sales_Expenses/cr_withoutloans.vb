...
Public Class cr_withoutloans
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IRES.cr_withoutloans.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_withoutloans
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_withoutloans = New cr_withoutloans()
        rpt.Site = Me.Site
        Return rpt
    End Function
