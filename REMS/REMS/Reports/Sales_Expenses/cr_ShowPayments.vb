...
Public Class cr_ShowPayments
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IRES.cr_ShowPayments.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_ShowPayments
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_ShowPayments = New cr_ShowPayments()
        rpt.Site = Me.Site
        Return rpt
    End Function
