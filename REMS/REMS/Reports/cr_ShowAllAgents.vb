...
Public Class cr_ShowAllAgents
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IRES.cr_ShowAllAgents.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_ShowAllAgents
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_ShowAllAgents = New cr_ShowAllAgents()
        rpt.Site = Me.Site
        Return rpt
    End Function
