...
Public Class crDueCollectables
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IRES.crDueCollectables.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDueCollectables
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDueCollectables = New crDueCollectables()
        rpt.Site = Me.Site
        Return rpt
    End Function
