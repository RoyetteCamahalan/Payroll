...
Public Class crPaymentHistory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IRES.crPaymentHistory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrPaymentHistory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crPaymentHistory = New crPaymentHistory()
        rpt.Site = Me.Site
        Return rpt
    End Function
