...
Public Class cr_forfeiting_per_property
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "cr_forfeiting_per_property.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IRES.cr_forfeiting_per_property.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_propid() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_sortparam() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedcr_forfeiting_per_property
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_forfeiting_per_property = New cr_forfeiting_per_property()
        rpt.Site = Me.Site
        Return rpt
    End Function
